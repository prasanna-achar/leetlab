...
function reverseList(head) {
  ...
  return (
    <div className="hidden lg:flex flex-col items-center justify-center bg-gray-950 text-white p-12 relative overflow-hidden">
        ...
        <div className="w-full bg-slate-800 rounded-lg shadow-xl mb-8 overflow-hidden">
          ...
          <div className="bg-slate-700 px-4 py-2 flex items-center">
            <div className="flex space-x-2 mr-4">
              <div className="w-3 h-3 rounded-full bg-red-500" onClick={() => setTextColor('text-red-400')}></div>
              <div className="w-3 h-3 rounded-full bg-yellow-500" onClick={() => setTextColor('text-yellow-400')}></div>
              <div className="w-3 h-3 rounded-full bg-green-500" onClick={() => setTextColor('text-green-400')}></div>
            </div>
          ...
          <div className="p-4 font-mono text-xs sm:text-sm overflow-hidden relative h-64">
            <pre className={`whitespace-pre-wrap ${textColor} transition-opacity duration-1000`}>
